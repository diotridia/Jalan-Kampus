...
@section('content')
    ...
    <section class="main-section">
        ...
        <div class="content">
            ...
            <form action="{{ route('ptkAdmin.update', $datas->id) }}" method="post"> <!-- ptk = nama controller // update = nama fungsi -->
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="kuota" name="kuota" value="{{ $datas->kuota }}">
                </div>
                <div class="form-group">
