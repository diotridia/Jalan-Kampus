...
class PtnAdmin extends Controller
{
    ...
    public function index()
    {
		   ...
		   return view('ptnAdmin', compact('data'));
    }
    ...
    public function store(Request $request)
    {
		...
		$data->save();
		return view('ptnAdmin_create')->with('alert-success','Berhasil Menambahkan Data!');
    }
    ...
    public function edit($id)
    {
		...
		return view('ptnAdmin_edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->penyelenggara = $request->penyelenggara;
		$data->save();
		return redirect()->route('ptnAdmin.index')->with('alert-success','Data Berhasil Diubah!');
    }
    ...
    public function destroy($id)
    {
        $data = ModelPtnAdmin::where('id',$id)->first();
		$data->delete();
		return redirect()->route('ptnAdmin.index')->with('alert-success','Data Berhasil Dihapus!');
    }
}
